...
class Vector3 {
    ...
    static cross(other1, other2) {
		...
		let cx = (other1.elements[1] * other2.elements[2]) - (other1.elements[2] * other2.elements[1]);
		let cy = -1 *((other1.elements[0] * other2.elements[2]) - (other1.elements[2] * other2.elements[0]));
		let cz = (other1.elements[0] * other2.elements[1]) - (other1.elements[1] * other2.elements[0]);
		
        let v3 = new Vector3([cx,cy,cz]); // Modify this line to calculate cross product between other1 and other2.
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        // Insert your code here.
        let m = Math.sqrt(Math.pow(this.elements[0], 2) +
						  Math.pow(this.elements[1], 2) +
						  Math.pow(this.elements[2], 2)); // Modify this line to calculate this vector's magnitude.
	...
	/**
      * Calculate the angle between vectors v1 & v2.
      * @return angle
      */
	angleBetween(v1,v2){
		// theta = arccos[ v1 . v2 / ||v1|| * ||v2||]
		let a = Math.acos(Vector3.dot(v1,v2) / (v1.magnitude() * v2.magnitude()));
	...
	/**
      * Calculate the area of the triangle created with v1 & v2.
      * @return area
      */
	areaTriangle(v1,v2){
		// area = || v1 x v2 || / 2
